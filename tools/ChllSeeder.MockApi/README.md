...
It's dev-only tooling: not part of `ChllSeeder.sln`, not built in CI.
...
# or: $env:CHLL_SEEDER_API_URL = 'http://localhost:3000'; <launch CHLLSeeder.exe>
```
