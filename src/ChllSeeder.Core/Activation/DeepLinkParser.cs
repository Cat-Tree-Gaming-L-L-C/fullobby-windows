...
/// <summary>
/// Parses <c>chllseeder://</c> URLs into <see cref="DeepLinkAction"/>s.
/// Port of <c>src-rust/src/platform/deep_link.rs</c> (rebranded scheme).
/// Expected format: <c>chllseeder://auth/callback?token=...&amp;refresh_token=...</c>
/// </summary>
public static class DeepLinkParser
{
    ...
    /// <c>chllseeder://</c> scheme; otherwise an action (possibly <see cref="DeepLinkAction.Unknown"/>).
    /// </summary>
