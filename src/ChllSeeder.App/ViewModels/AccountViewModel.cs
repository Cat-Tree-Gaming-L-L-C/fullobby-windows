...
public sealed partial class AccountViewModel : ObservableObject
{
    ...
    /// <summary>Handle <c>chllseeder://auth/callback</c>: validate CSRF state, store the JWT,
    ...
    /// <summary>Handle <c>chllseeder://auth/link-callback</c>: refresh linked providers + Steam IDs
