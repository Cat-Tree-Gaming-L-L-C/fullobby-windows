...
/// <summary>Tests for <c>fullobby://</c> deep-link parsing.</summary>
public class DeepLinkParserTests
{
    [Fact]
    public void ParseValidAuthCallback()
    {
        var action = DeepLinkParser.Parse("fullobby://auth/callback?token=abc123&refresh_token=def456");
    ...
    {
        var action = DeepLinkParser.Parse("fullobby://auth/callback?token=abc&refresh_token=def&state=xyz789");
    ...
    {
        var action = DeepLinkParser.Parse("fullobby://auth/callback?token=abc123");
    ...
    {
        var action = DeepLinkParser.Parse("fullobby://auth/callback?token=&refresh_token=def");
    ...
    {
        var action = DeepLinkParser.Parse("fullobby://auth/callback?token=abc&refresh_token=");
    ...
    {
        var action = DeepLinkParser.Parse("fullobby://auth/link-callback?provider=steam&provider_id=12345");
    ...
    {
        var action = DeepLinkParser.Parse("fullobby://auth/link-callback?provider=discord&provider_id=99999");
    ...
    public void ParseValidLinkCallbackEpicXbox(string provider, string providerId)
    {
        var action = DeepLinkParser.Parse(
            $"fullobby://auth/link-callback?provider={provider}&provider_id={providerId}&linked=true");
    ...
    {
        var action = DeepLinkParser.Parse("fullobby://auth/link-callback?provider=twitch&provider_id=123");
    ...
    {
        var action = DeepLinkParser.Parse("fullobby://auth/link-callback?provider=steam");
    ...
    {
        var action = DeepLinkParser.Parse("fullobby://auth/register-callback?token=abc123&state=xyz789");

        var reg = Assert.IsType<DeepLinkAction.RegisterCallback>(action);
        Assert.Equal("abc123", reg.Token);
        Assert.Equal("xyz789", reg.State);
    }

    [Fact]
    public void ParseRegisterCallbackWithoutState()
    {
        var action = DeepLinkParser.Parse("fullobby://auth/register-callback?token=abc123");
    ...
    [Fact]
    public void ParseRegisterCallbackMissingToken()
    {
        var action = DeepLinkParser.Parse("fullobby://auth/register-callback?state=xyz789");

        Assert.IsType<DeepLinkAction.Unknown>(action);
    }

    [Fact]
    public void ParseRegisterCallbackEmptyToken()
    {
        var action = DeepLinkParser.Parse("fullobby://auth/register-callback?token=&state=xyz789");
    ...
    {
        var action = DeepLinkParser.Parse("fullobby://auth/callback?token=abc%20def&refresh_token=ghi%26jkl");
    ...
    [Fact]
    public void ParseNonFullobbySchemeReturnsNull()
    {
    ...
    {
        var action = DeepLinkParser.Parse("fullobby://some/random/path");
    ...
    {
        var action = DeepLinkParser.Parse("  fullobby://auth/callback?token=abc&refresh_token=def  ");
    ...
    public void OversizedParameterIsRejected()
    {
        ...
        var action = DeepLinkParser.Parse($"fullobby://auth/callback?token={bigToken}&refresh_token=def");
    ...
    public void ExcessParametersAreIgnored()
    {
        ...
        var action = DeepLinkParser.Parse($"fullobby://auth/callback?{junk}&token=abc&refresh_token=def");
