...
public static class UpdateSignature
{
    ...
    public const string SchemeTag = "chll-seeding-update.v1";
    ...
    private static readonly string[] TrustedSigningKeysBase64 =
    {
        ...
        // Generated 2026-06 — rotation runbook in the private chll-seeding-api repo (add new key here first).
