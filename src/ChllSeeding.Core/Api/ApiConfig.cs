...
/// (always HTTPS) and cannot be redirected — the <c>CHLL_SEEDING_API_URL</c> override is
...
///
/// <para>Debug builds honor the <c>CHLL_SEEDING_API_URL</c> environment override (handy for
