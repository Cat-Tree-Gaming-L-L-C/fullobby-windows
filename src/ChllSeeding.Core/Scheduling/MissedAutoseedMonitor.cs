...
public sealed class MissedAutoseedMonitor : IHostedService, IDisposable
{
    ...
    /// strictly less than <paramref name="windowHours"/> past it. The upper bound is exclusive to match
    /// Rust's <c>diff.num_hours() &gt;= MISSED_AUTOSEED_WINDOW_HOURS</c> skip (autoseed.rs:335), which
    /// drops anything at or beyond the whole-hour mark. Pure; unit-tested.
    /// </summary>
