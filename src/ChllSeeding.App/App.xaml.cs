...
public partial class App : Application
{
    ...
    {
        AppHost.Start();
        Log.Information("CHLL Seeding v{Version} starting",
        ...
        {
            Log.Warning(ex, "chllseeding:// protocol registration failed");
        }

        // Activations redirected from secondary instances (chllseeding:// deep links)
    ...
    private void HandleActivation(AppActivationArguments args)
    {
        ...
        switch (DeepLinkParser.Parse(uri))
        {
            ...
            case DeepLinkAction.Unknown unknown:
                ...
                break;
            case null:
                Log.Warning("Ignored non-chllseeding URI activation");
                break;
        }
    }
    ...
    private static IHost BuildHost()
    {
        ...
        Log.Logger = new LoggerConfiguration()
            ...
            .WriteTo.File(
                Path.Combine(logsDir, "chll-seeding-.log"),
